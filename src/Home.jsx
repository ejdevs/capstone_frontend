  ...
  const handleIndexDatalogs = () => {
    ...
    axios.get("http://localhost:3000/datalogs.json").then((response) => {
      ...
      let extData = [
        ...
        { name: "af_sens_1_ratio", data: [] },
        { name: "baro_pressure", data: [] },
        { name: "cl_fuel_target", data: [] },
        { name: "calculated_load", data: [] },
        { name: "comm_fuel_final", data: [] },
        { name: "coolant_temp", data: [] },
        { name: "feedback_knock", data: [] },
        { name: "fuel_pressure", data: [] },
        { name: "fuel_pressure_target", data: [] },
        { name: "ignition_timing", data: [] },
        { name: "inj_duty_cycle", data: [] },
        { name: "intake_temp", data: [] },
        { name: "intake_temp_manifold", data: [] },
        { name: "maf_volts", data: [] },
        { name: "req_torque", data: [] },
        { name: "td_boost_error_ext", data: [] },
        { name: "tgv_map_ratio", data: [] },
        { name: "wastegate_duty", data: [] },
        // { name: "ap_info", data: [] },
      ];
      let accelThrottle = [
        { name: "accel_position", data: [] },
